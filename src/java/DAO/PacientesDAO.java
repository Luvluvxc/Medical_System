...
public class PacientesDAO {
    ...
    public int Agregar(PacientesModel p) {
        ...
        try {
            ...
            String codigoPaciente = p.getCodigoPaciente();
            if (codigoPaciente == null || codigoPaciente.isEmpty()) {
                codigoPaciente = "PAC-" + System.currentTimeMillis();
            }
            json.put("codigoPaciente", codigoPaciente);
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                if (resultado == -1) {
                    System.out.println("[v0] Error: Ya existe un paciente con este usuario");
                } else {
