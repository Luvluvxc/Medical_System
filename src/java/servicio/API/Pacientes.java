...
public class Pacientes {
    ...
    public int agregar(String jsonString) {
        ...
        String checkSql = "SELECT COUNT(*) as count FROM pacientes WHERE usuario_id = ?";
        ...
        try {
            ...
            long usuarioId = json.getLong("usuarioId");
            ...
            if (rs.next() && rs.getInt("count") > 0) {
                System.out.println("[v0] Error: Ya existe un paciente con este usuario_id: " + usuarioId);
            ...
            String codigoPaciente = json.optString("codigoPaciente", "PAC-" + System.currentTimeMillis());
            ...
            if (json.has("fechaNacimiento") && !json.isNull("fechaNacimiento")) {
                ps.setDate(3, Date.valueOf(LocalDate.parse(json.getString("fechaNacimiento"))));
            } else {
