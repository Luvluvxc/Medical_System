                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 text-end">
                            <div class="btn-group" role="group">
                                <button class="btn btn-primary filter-btn active btn-role" onclick="filtrarPorRol('todos')">
                                    <i class="bi bi-people"></i> Todos
                                </button>
                                <button class="btn btn-success filter-btn btn-role" onclick="filtrarPorRol('paciente')">
                                    <i class="bi bi-person"></i> Pacientes
                                </button>
                                <button class="btn btn-info filter-btn btn-role" onclick="filtrarPorRol('doctor')">
                        ...
                        <table class="table table-hover align-middle" id="usuariosTable">
                            <thead style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                                <tr>
                                    ...
                                    <th class="contact-info">Contacto</th>
                                    <th class="role-cell">Rol</th>
                                    <th class="status-cell">Estado</th>
                                    <th class="actions-cell text-center">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                            ...
                                            <td class="role-cell">
                                                <c:choose>
                                                    <c:when test="${usuario.rol == 'paciente'}">
                                                        ...
                                                        <span class="badge badge-sin-registro action-badge d-none" data-tipo="paciente">
                                                    ...
                                                    <c:when test="${usuario.rol == 'doctor'}">
                                                        ...
                                                        <span class="badge badge-sin-registro action-badge d-none" data-tipo="doctor">
                                                            <i class="bi bi-exclamation-circle"></i> Sin Registro
                                                        </span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="badge bg-secondary status-badge">${usuario.rol}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
